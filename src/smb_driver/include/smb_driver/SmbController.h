...
class SmbController : public rclcpp::Node {
...
public:
    ...
    SmbController(std::string port, std::shared_ptr<rclcpp::Node> node, size_t vecSize = 10, bool sendCommands = true, double lin_vel_scale = 1, double ang_vel_scale = 1);
...
//	RTIME minPeriod_ = 20000000; //[nanosecs]
    ...
    rclcpp::Publisher<std_msgs::msg::Float64MultiArray>::SharedPtr wheelSpeedPub_;
    rclcpp::Publisher<geometry_msgs::msg::Twist>::SharedPtr rcTwistPub_;
    std_msgs::msg::Float64MultiArray wheelSpeedMsg_;
